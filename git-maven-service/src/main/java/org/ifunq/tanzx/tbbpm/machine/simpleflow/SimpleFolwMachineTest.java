...
public class SimpleFolwMachineTest {
	...
	public static void main(String[] args) throws Exception {
        ...
        StateMachineEngineFactory.getInstance(stateMachineStateService).triggerStateTransfer(stateId, "SUBMITED_2_APPROVAL", null);
        StateMachineEngineFactory.getInstance(stateMachineStateService).triggerStateTransfer(stateId, "APPROVAL_2_ISSUED", null);
        StateMachineEngineFactory.getInstance(stateMachineStateService).triggerStateTransfer(stateId, "ISSUED_2_END", null);
	}
